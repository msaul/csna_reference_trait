...
pleio_tib <- scan_pvl_2(probs        = apr[[chromosome]],
                        ...
                        start_snp    = min_chr,
                        n_snp        = n_snps)
saveRDS(pleio_tib,"~/projects/example/DO_SENS_SALINE_pleio_pvl.RDS")
pleio_tib_lods = calc_profile_lods(pleio_tib) %>%
  add_pmap(pmap = DO_str_2016_cross$pmap[[chromosome]])
...
saveRDS(pleio_tib_lods,"~/projects/example/DO_SENS_SALINE_pleio_lods.RDS")
...
save(list = c("pleio_lrt","pleio_index","pleio_boot"),
     file = "~/projects/example/DO_SENS_SALINE_pleio_boot.RData")
...
pleio_plot = ggplot(data = pleio_tib_lods, aes(x        = marker_position,
  ...
  ylab("LOD") +
  ggtitle("Pleiotropy Analysis: SENS vs Sensi")
