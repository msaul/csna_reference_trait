...
pheno_col1 = "RTG_a3"
pheno_col2 = "cocaine_novelty_cancor"
...
# Saving input data
# save(list = ls(), file = "/projects/csna/rta/DO_IVSA_SENS_pleio_input.RData")
...
pleio_tib <- scan_pvl_2(probs        = apr[[chromosome]],
                        ...
                        start_snp    = min_chr,
                        n_snp        = n_snps)
saveRDS(pleio_tib,"/projects/csna/rta/data/DO_IVSA_SENS_pleio_pvl.RDS")
...
saveRDS(pleio_tib_lods,"/projects/csna/rta/DO_IVSA_SENS_pleio_lods.RDS")
...
save(list = c("pleio_lrt","pleio_index","pleio_boot"),
     file = "/projects/csna/rta/data/DO_IVSA_SENS_pleio_boot.RData")
...
pleio_plot = ggplot(data = pleio_tib_lods, aes(x        = marker_position,
  ...
  ylab("LOD") +
  ggtitle("Pleiotropy Analysis: IVSA vs Sensi")
